...
workflow: 1. always keep a project_journal.md in projects where you write for each large step what you did, why you did it and what issues/key-learnings you had. it shall explain, how the project was implemented.
2. write key learnings into KEY_LEARNINGS.md and consider them when making decissions.
...
docs/OpenADR 3.1.0 Spec Package_public/pdf/: do not read, search, or reference any files under this directory. Use the markdown versions in docs/OpenADR 3.1.0 Spec Package_public/ instead.