...
def step_at_least_one_chip(context):
    ...
    page.wait_for_selector('[data-testid^="trigger-chip-"]', timeout=30000)
...
def step_matrix_has_asset_rows(context):
    page = context.browser_page
    page.wait_for_selector(tid("decision-matrix"), timeout=30000)
...
def step_matrix_has_tariff_header(context):
    page = context.browser_page
    header = page.wait_for_selector(tid("matrix-tariff-header"), timeout=30000)
...
def step_click_first_matrix_cell(context):
    page = context.browser_page
    page.wait_for_selector('[data-testid^="matrix-cell-"]', timeout=30000)
    cells = page.query_selector_all('[data-testid^="matrix-cell-"]')
