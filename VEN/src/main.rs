...
fn resolve_resolution_s(params: &TimelineParams, total_window_s: f64) -> u64 {
...
fn serialize_now_point(point: &controller::trace::AssetTimelinePoint) -> serde_json::Value {
...
async fn get_timeline(
    ...
    use controller::timeline::compute_uniform_grid;
...
fn build_grid_aligned_array(
    asset_id: &str,
    known_assets: &std::collections::HashSet<String>,
    history: &HashMap<String, controller::trace::AssetHistoryBuffer>,
    plan: Option<&entities::plan::Plan>,
    now: DateTime<Utc>,
    hours_back: f64,
    hours_forward: f64,
