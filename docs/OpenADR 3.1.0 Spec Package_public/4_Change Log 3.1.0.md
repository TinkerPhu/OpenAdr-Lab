...
3.1.0 is NOT fully backwards compatible with 3.0.1 as some changes to API endpoints (e.g.
/resources), request bodies (e.g. VENs and resources), and query params (e.g. targets) have
been introduced to make the interface more secure, compact, and easier to use.
...
| 267       | Event interval payload type to facilitate communicating special dispatch
instructions |
...
| 187       | Restructure OpenAPI spec/schemas to properly define and distinguish between
