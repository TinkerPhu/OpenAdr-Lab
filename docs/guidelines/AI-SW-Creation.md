...
- UNCLEAR: small source code files could strongly improve efficiency (no god classes)
...
- Reviews
- Create mermaid schematic of module architecture. display all entities and classes and their dependencies. list all architectural violations.
...
- Decide for Architecture, Guidelines, Linter, CodeCoverage - write it into constitution.
...
- Create workflow and make rules to follow it
