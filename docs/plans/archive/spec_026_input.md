...
- **FR-002**: `build_measurement_report` MUST accept `asset_samples: &HashMap<String, Vec<AssetReportSample>>` and `grid_net_import_kw: f64` instead of `sim: &SimState`.
