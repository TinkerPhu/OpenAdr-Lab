...
- [[power-envelope-forecast-basis]] — **open/unfinished**: why real DNSP power-envelope forecasts vary hour-by-hour (voltage-rise vs. thermal-loading constraints moving in opposite directions), how SA Power Networks/Energex actually compute them, and a sourced critique of a static equal-share allocation proposal (diversity factor, import/export asymmetry, round-robin vs. continuous dynamic allocation)

---
Pages: 44 · Last sync: 2026-08-11 (17b702a: history-envelope-persistence — SCHEMA_V9 grid_samples capacity-limit columns, tightest-value-wins accumulation, History tab tariff/envelope+rates chart split; new query page power-envelope-forecast-basis filed as an explicitly open/unfinished external-research discussion; tariffs-and-capacity updated with the parse_capacity_schedule/history persistence section)
